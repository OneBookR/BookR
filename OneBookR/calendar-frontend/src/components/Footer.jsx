        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <a href="/integritetspolicy#cookies" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '14px' }}>Cookiepolicy</a>
              <a href="/anvandarvillkor" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '14px' }}>Villkor och bestämmelser</a>
            </Box>
          </Grid>
